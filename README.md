...
|------|-------------|------|---------|:--------:|
| <a name="input_type"></a> [type](#input\_type) | Protocol/type of the health check. | `string` | n/a | yes |
...
| <a name="input_failure_threshold"></a> [failure\_threshold](#input\_failure\_threshold) | Number of consecutive failures before considering the endpoint unhealthy. | `number` | `3` | no |
| <a name="input_fqdn"></a> [fqdn](#input\_fqdn) | Fully qualified domain name of the endpoint to health check. | `string` | `null` | no |
...
| <a name="input_ip_address"></a> [ip\_address](#input\_ip\_address) | IP address of the endpoint to health check. | `string` | `null` | no |
...
| <a name="input_port"></a> [port](#input\_port) | Port of the endpoint to health check. | `number` | `null` | no |
| <a name="input_regex_replace_chars"></a> [regex\_replace\_chars](#input\_regex\_replace\_chars) | Terraform regular expression (regex) string.<br/>Characters matching the regex will be removed from the ID elements.<br/>If not set, `"/[^a-zA-Z0-9-]/"` is used to remove all characters other than hyphens, letters and digits. | `string` | `null` | no |
| <a name="input_request_interval"></a> [request\_interval](#input\_request\_interval) | Number of seconds between health check requests (10 or 30). | `number` | `30` | no |
| <a name="input_resource_path"></a> [resource\_path](#input\_resource\_path) | Path that the health check requests when checking HTTP/HTTPS endpoints. | `string` | `null` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_arn"></a> [arn](#output\_arn) | The ARN of the Route53 health check. |
| <a name="output_enabled"></a> [enabled](#output\_enabled) | Whether the module is enabled. |
| <a name="output_id"></a> [id](#output\_id) | The id of the Route53 health check. |
<!-- END_TF_DOCS -->
